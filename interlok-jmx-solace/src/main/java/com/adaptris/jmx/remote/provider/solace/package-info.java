 ...
 * JMXConnectorFactory#newJMXConnector()}. All keys are case sensitive and if specified on the URL, will be stripped before being
 * passed to {@code
 ...
 * <td>A comma separated list of additional brokers that should serve as a list of backup brokers. Note that doing this as part of
 * the URL will make it hard to read, so that should be discouraged from maintainability point of view, it will be best to add the
 * backup brokers as part of the initial environment</td>
 * </tr>
 * </table>
 * <p>
