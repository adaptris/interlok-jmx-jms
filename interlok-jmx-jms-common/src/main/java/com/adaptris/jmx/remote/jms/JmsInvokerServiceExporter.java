...
public class JmsInvokerServiceExporter extends RemoteInvocationBasedExporter
     ...
     * using a standard JMS {@link jakarta.jms.ObjectMessage} for each invocation /
     ...
     * @throws jakarta.jms.JMSException in case of message access failure
     */
    @Nullable
     ...
     * @throws jakarta.jms.JMSException if thrown by trying to send the message
     */
     ...
     * @throws jakarta.jms.JMSException if creating the message failed
     */
     ...
     * @throws jakarta.jms.JMSException in case of the invalid request supposed
