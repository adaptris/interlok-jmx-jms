...
public abstract class JmsInvokerFactory {
  ...
  private static final Logger log = LoggerFactory.getLogger(JmsInvokerFactory.class);
   ...
   *
   * @param factory the {@link JmsJmxConnectionFactory} instance.
   * @param type the type of {@link JmsInvokerProxy}
   * @return a {@link JmsInvokerProxy} instance.
   * @throws JMSException if there was a problem with JMS.
   * @see #TYPE_QUEUE
   * @see #TYPE_TOPIC
   ...
   *
   * @param type the type of {@link ExtendedJmsInvokerServiceExporter}
   ...
   */
  public static ExtendedJmsInvokerServiceExporter createServiceExporter(String type)
      throws JMSException {
